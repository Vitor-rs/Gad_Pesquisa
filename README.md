...
Este projeto está sendo desenvolvido no âmbito acadêmico do Instituto Federal de Mato Grosso do Sul, seguindo as diretrizes institucionais para projetos de pesquisa e desenvolvimento tecnológico.

---

**Sistema GAD** - Transformando a gestão acadêmica através da Inteligência Artificial 🤖📚
